package com.tanzir.weatherapp.adapter

import android.widget.ImageView
import android.widget.TextView
import androidx.databinding.BindingAdapter
import com.bumptech.glide.Glide
import com.tanzir.weatherapp.file.getFormattedDate
import com.tanzir.weatherapp.file.icon_prefix
import com.tanzir.weatherapp.file.icon_sufffix

@BindingAdapter("app:setWeatherIcon")
fun setIcon(imageView: ImageView, icon: String?) {
    icon?.let {
        val url = "$icon_prefix$icon$icon_sufffix"
        Glide
