...
import com.tanzir.weatherapp.databinding.ForecastItemRowBinding
import com.tanzir.weatherapp.models.ForecastModel

class ForecastAdapter() :
    ListAdapter<ForecastModel.ForecastList, ForecastAdapter.ForecastViewHolder>(ForecastDiffUtil()) {
